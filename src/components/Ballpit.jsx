...
const Ballpit = ({ className = '', followCursor = true, style = {}, ...props }) => {
  ...
  useEffect(() => {
    ...
    // Dynamically create a fresh canvas every mount so React Strict Mode's
    // cleanup → remount cycle doesn't reuse a canvas whose WebGL context was
    // destroyed by forceContextLoss().
